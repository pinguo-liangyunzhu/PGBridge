...
;(function(){window.PGPromise=function(func){if(!(func instanceof Function)){throw new Error('not a function');return;}
	...
	func&&func(resolve);}
	var fn=window.PGPromise.prototype;fn.then=function(func){if(!(func instanceof Function)){throw new Error('not a function');return this;}
		this.callbackArr.push(func);return this;}})();
